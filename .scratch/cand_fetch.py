...
MAX_CARRIERS = 8
# Extra wheat demand so the dawn run empties the shed instead of leaving one
# unit behind for a top-up trip after every FEED.
FETCH_SLACK = 8
...
def agent(obs):
    ...
    fetch = dict(want)
    fetch["WHEAT"] = n_animals + FETCH_SLACK
