        ...
        for x, t in enumerate(row):
            ...
            if kind == "PLANT":
                ...
                if day < LAST_DAY and not t.get("cared_today"):
                    ...
                    # productions yields 3 milk instead of 1. Offered *before* the
                    # collect job at the same tile: both sit in band 2 at distance
                    # zero from the same unit, so the tie breaks on list order, and
                    # a cared production is worth $116-223 against a $60 fertilizer.
